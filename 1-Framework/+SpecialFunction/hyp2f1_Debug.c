...
double a, b, c, x;
{
    ...
    mexPrintf("hyp2f1 was called with a = %f, b = %f, c = %f, x = %f.\n", a, b, c, x);
	...
	if (fabs(a) < fabs(b)) {
		mexPrintf("hyp2f1 returned %f.\n", pow(s, -a) * hyp2f1(a, c - b, c, x / (x - 1)));
	    return pow(s, -a) * hyp2f1(a, c - b, c, x / (x - 1));
	}
	else {
		mexPrintf("hyp2f1 returned %f.\n", pow(s, -b) * hyp2f1(b, c - a, c, x / (x - 1)));
...
double *loss;
{
    ...
    mexPrintf("hyt2f1 was called with a = %f, b = %f, c = %f, x = %f.\n", a, b, c, x);
...
{
    mexPrintf("hys2f1 was called with a = %f, b = %f, c = %f, x = %f.\n", a, b, c, x);
    
    double f, g, h, k, m, s, u, umax, t;
    int i;
    int ia, ib, intflag = 0;

	mexWarnMsgIdAndTxt("mexhyp2f1:hyp2f1", "hys2f1 called.");
	 ...
	 */
	mexPrintf("hys2f1 returned %f.\n", hyp2f1ra(a, b, c, x, loss));
		       ...
		       double *loss)
{
    ...
    mexPrintf("hyp2f1ra was called with a = %f, b = %f, c = %f, x = %f.\n", a, b, c, x);
